...
public sealed class PatternTelemetryData
{
    ...
    public List<PatternSignalData> PatternSignals { get; set; } = new();
    public List<PatternReliabilityData> PatternReliabilities { get; set; } = new();
}
...
public sealed class FusionRiskTelemetryData
{
    ...
    public List<RiskRejectionData> RiskRejections { get; set; } = new();
}
