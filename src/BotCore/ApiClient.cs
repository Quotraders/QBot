...
#nullable enable
        ...
        private sealed record AvailableResp(IReadOnlyList<ContractDto>? contracts, bool success, int errorCode, string? errorMessage);
        ...
        private sealed record SearchResp(IReadOnlyList<ContractDto>? contracts, bool success, int errorCode, string? errorMessage);
