...
public class SafeHoldDecisionPolicy
{
        ...
        double blockAtr, double allowBreak, double sizeTiltFactor, ZoneSource source)
    {
        ...
        if ((double)snap.DistToSupplyAtr <= blockAtr && (double)snap.BreakoutScore < allowBreak)
        {
        ...
        if ((double)snap.DistToSupplyAtr < 1.0)
        {
        ...
        double blockAtr, double allowBreak, double sizeTiltFactor, ZoneSource source)
    {
        ...
        if ((double)snap.DistToDemandAtr <= blockAtr && (double)snap.BreakoutScore < allowBreak)
        {
        ...
        if ((double)snap.DistToDemandAtr < 1.0)
        {
