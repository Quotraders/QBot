...
namespace BotCore.Configuration
{
    ...
    /// <summary>
    /// Enhanced configuration for Production Resilience Service
    /// AUDIT-CLEAN: All values must come from configuration with validation
    /// </summary>
    public class ResilienceConfiguration
    {
        ...
        /// <summary>
        /// HTTP operation timeout (in milliseconds)
        /// </summary>
        ...
        /// <summary>
        /// Circuit breaker timeout before attempting reset (in milliseconds)
        /// </summary>
        public int CircuitBreakerTimeoutMs { get; set; } = 60000;
        
        /// <summary>
        /// Enable circuit breaker logging and telemetry
        /// </summary>
        public bool EnableCircuitBreakerTelemetry { get; set; } = true;
        
        /// <summary>
        /// Telemetry prefix for resilience related logs and metrics
        /// </summary>
        public string TelemetryPrefix { get; set; } = "resilience";
        ...
        {
            if (MaxRetries <= 0)
                throw new ArgumentOutOfRangeException("MaxRetries", "MaxRetries must be greater than 0");
                
            if (BaseRetryDelayMs <= 0)
                throw new ArgumentOutOfRangeException("BaseRetryDelayMs", "BaseRetryDelayMs must be greater than 0");
                
            if (MaxRetryDelayMs <= 0)
                throw new ArgumentOutOfRangeException("MaxRetryDelayMs", "MaxRetryDelayMs must be greater than 0");
                
            if (HttpTimeoutMs <= 0)
                throw new ArgumentOutOfRangeException("HttpTimeoutMs", "HttpTimeoutMs must be greater than 0");
                
            if (CircuitBreakerThreshold <= 0)
                throw new ArgumentOutOfRangeException("CircuitBreakerThreshold", "CircuitBreakerThreshold must be greater than 0");
                
            if (CircuitBreakerTimeoutMs <= 0)
                throw new ArgumentOutOfRangeException("CircuitBreakerTimeoutMs", "CircuitBreakerTimeoutMs must be greater than 0");
