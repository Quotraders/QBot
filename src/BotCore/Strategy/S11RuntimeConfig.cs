...
public static class S11RuntimeConfig
{
    public static decimal MinAtr { get; private set; } = 0.9m;
    public static decimal StopAtrMult { get; private set; } = 3.0m;
    public static decimal TargetAtrMult { get; private set; } = 6.0m;
